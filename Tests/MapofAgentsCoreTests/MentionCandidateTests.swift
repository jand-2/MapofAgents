...
func bundledWorkflowBridgeSkillUsesMapofAgentsURI() {
    ...
    #expect(MapofAgentsWorkflowBridgeSkill.instructions.contains("mapofagents provider relay"))
    #expect(MapofAgentsWorkflowBridgeSkill.instructions.contains("Do not load a Gemini or Grok thread through the Codex App Server"))
    #expect(MapofAgentsWorkflowBridgeSkill.instructions.localizedCaseInsensitiveContains("do not automatically retry"))
